...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """calculator""", """controllers.CalculatorController.calculator(pretaxincome:Double, otherincome:Double, taxyear:String)"""),
  ...
  private[this] lazy val controllers_CalculatorController_calculator1_invoker = createInvoker(
    CalculatorController_0.calculator(fakeValue[Double], fakeValue[Double], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.CalculatorController",
      "calculator",
      Seq(classOf[Double], classOf[Double], classOf[String]),
      "GET",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_CalculatorController_calculator1_route(params@_) =>
      call(params.fromQuery[Double]("pretaxincome", None), params.fromQuery[Double]("otherincome", None), params.fromQuery[String]("taxyear", None)) { (pretaxincome, otherincome, taxyear) =>
        controllers_CalculatorController_calculator1_invoker.call(CalculatorController_0.calculator(pretaxincome, otherincome, taxyear))
      }
